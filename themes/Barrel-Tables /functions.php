...
function hm_base_theme_scripts() {
	...
	wp_enqueue_script( 'Isotope Filter', get_stylesheet_directory_uri() . '/js/isotope.pkgd.min.js', array('bootstrap-js','jquery'), $version, true );
	wp_enqueue_script( 'gnmenu', get_stylesheet_directory_uri() . '/js/gnmenu.js', array('bootstrap-js','jquery'), $version, true );
	wp_enqueue_script( 'classie', get_stylesheet_directory_uri() . '/js/classie.js', array('bootstrap-js','jquery'), $version, true );
	wp_enqueue_script( 'modernizr', get_stylesheet_directory_uri() . '/js/modernizr.custom.js', array('bootstrap-js','jquery'), $version, true );
